...
# PASSWORD KHUSUS GURU
PASSWORD_GURU = "guruku123"

#   REGISTER
def daftar():
    print("\n=== DAFTAR AKUN ===")
    username = input("Username (huruf saja): ")

    if not username.isalpha():
        print("Username hanya boleh huruf tanpa angka atau simbol!\n")
        return
    ...
    # Password khusus untuk guru
    if peran == "guru":
        if password != PASSWORD_GURU:
            print("Password guru salah! Pendaftaran ditolak.\n")
            return
...
def lihat_pengumpulan(username):
    ...
    for p in jawaban:
        print(f"- {p['siswa']} mengumpulkan: {p['file']}")
    print("")
...
#   MAIN MENU
while True:
    print("=== SISTEM KELAS ONLINE SEDERHANA ===")
    print("1. Daftar Akun")
    print("2. Login")
    print("3. Keluar")
